...
{
    /// <summary>
    ///     Represents our application user information.
    /// </summary>
    public class ApplicationUser : IdentityUser<Guid>
    {
        ...
        {
            return string.Format("[{0}] Username: {1}, Creation: {2}, Last Modification: {3}",
                Id, 
                UserName, 
                CreationDate.ToString("yyyy-MM-dd"),
                ModificationDate?.ToString("yyyy-MM-dd") ?? string.Empty);
        }
    }
}
